            ...
            <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-around">
                <div className="flex flex-col justify-center gap-5 p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    ...
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                        <NavLink to={'ListedBook'} rel="noopener noreferrer" href="#" className="btn px-8 py-3 text-lg text-white bg-vibe-btn-primary font-semibold rounded">View The List</NavLink>
                    </div>
                </div>
